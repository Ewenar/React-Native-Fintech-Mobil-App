...
A user and a stock message are sent. The desired currency units can be written and added to the Stock array.if you want to access the server file [click here](https://github.com/Ewenar/React-Native-Fintech-Mobil-App/tree/main/websocket/StocksWebsocketDemoServer)
